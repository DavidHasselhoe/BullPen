...
export interface User {
  ...
  // Use `tierFromUser()` / `isPro()` from `lib/billing/tier.ts` instead of comparing directly.
  account_tier: number | null;
  // Referral-reward bonus Pro access (migrations 114/115) — independent of account_tier.
