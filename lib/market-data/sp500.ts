 ...
 * Source: Standard & Poor's index as of early 2026.
...
export const SP500_TICKERS: string[] = [
  ...
  'BDX', 'BRK.B', 'BBY', 'TECH', 'BIIB', 'BLK', 'BX', 'BA', 'BCR', 'BMY',
  'AVGO', 'BR', 'BRO', 'BF.B', 'BLDR', 'BSX', 'BMO', 'CHRW', 'CDNS', 'CZR',
  ...
  'DECK', 'DE', 'DAL', 'DVN', 'DXCM', 'FANG', 'DLR', 'DFS', 'DG', 'DLTR',
  ...
  'LH', 'LRCX', 'LW', 'LVS', 'LDOS', 'LEN', 'LII', 'LILLY', 'LIN', 'LYV',
  ...
  'TFX', 'TER', 'TSLA', 'TXN', 'TPL', 'TXT', 'TMO', 'TJX', 'TSCO', 'TT',
  ...
  'WST', 'WDC', 'WY', 'WMB', 'WTW', 'WYNN', 'XEL', 'XYL', 'YUM', 'ZBRA',
  'ZBH', 'ZTS',
];
