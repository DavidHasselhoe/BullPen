/**
 * Static GICS sector mapping for S&P 500 constituents (as of early 2026).
 * Used by the heatmap API to skip DB sector queries for the ~98% of tickers here.
 * Falls back to companies table → 'Other' for any ticker not listed.
 */
export const SP500_SECTORS: Record<string, string> = {
  // ── Communication Services ──────────────────────────────────────────────────
  AKAM: 'Communication Services',
