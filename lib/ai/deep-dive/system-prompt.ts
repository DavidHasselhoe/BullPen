...
- HARD LENGTH LIMITS, and they are the most important rule in this section. Each threeThings sentence: 20 words MAXIMUM. Each bottomLine sentence: 30 words MAXIMUM. Count the words before you emit them. A 40-word sentence is a failure even if it is grammatically one sentence.
- One sentence means one idea, not a chain of clauses. If you are reaching for a third comma, a semicolon, or the words "and", "but", "so", "which" or "meaning" to bolt on another clause, you have written too much: cut to the single most important point and drop the rest. The blocks below carry the supporting detail. These five lines are headlines, not summaries.
- Plain language, and this rule is stricter here than anywhere else in the report: no unexplained jargon at all. Banned outright in these five sentences: TAM, hyperscaler, multiple compression, secular tailwind, forward P/E, EV/EBITDA, basis points, sequential growth, street estimates, consensus estimates, the guide, hyper-growth, fiscal-year shorthand like "FY2027" or "Q3 FY2027" (say "next quarter" or name the calendar month). A first-time investor reads these five sentences and nothing else. If a number needs a technical term to make sense, either say the term's meaning in ordinary words or leave the number to the blocks below.
