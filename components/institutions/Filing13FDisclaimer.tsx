...
export function Filing13FDisclaimer({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <p className="text-xs leading-relaxed text-muted-foreground/80">
      ...
      for further delay on new positions. 13F filings disclose only US-listed equities, ETFs, and some options —
      they don&apos;t include short positions, cash, bonds, or most international holdings. This is a partial picture
      of the fund&apos;s actual portfolio, not the whole thing.
    </p>
  );
}
