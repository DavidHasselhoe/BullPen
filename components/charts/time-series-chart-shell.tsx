...
function resolveTimeSeriesYDomain(
  ...
  // Zero-baseline suits counter-style metrics (e.g. "users over time") but
  // crushes tightly-ranged series like stock prices into a sliver near the
  // top — opt out via `zeroBaseline={false}` for those.
  if (zeroBaseline && minValue >= 0) {
