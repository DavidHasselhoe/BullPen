...
const ChartCore = memo(function ChartCore({
  ...
  // Date values use the raw timestamp, not a formatted date string — a
  // day-granularity format collapses every same-day point (e.g. a full
  // day of 1-minute candles) onto one category, since scaleBand's domain
  // needs one distinct key per data point to keep them all visible.
