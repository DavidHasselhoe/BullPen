...
export function ExperienceOnboardingBanner() {
  ...
  const OPTIONS: { level: ExperienceLevel; label: string; description: string }[] = [
    {
      level: 'beginner',
      label: t('onboardingBeginnerLabel'),
      description: t('onboardingBeginnerDescription'),
    },
    {
      level: 'intermediate',
      label: t('onboardingIntermediateLabel'),
      description: t('onboardingIntermediateDescription'),
    },
    {
      level: 'advanced',
      label: t('onboardingAdvancedLabel'),
      description: t('onboardingAdvancedDescription'),
    },
  ];
  const { user } = useAuth();
