 ...
 */
const MOCK_LINES = [
  'NVDA jumped after a major cloud partner disclosed a large multi-year GPU order.',
  'Analysts at two banks raised price targets citing accelerating data-center demand.',
  'Volume ran well above average, suggesting institutional buying rather than retail momentum.',
];
