  ...
  return (
    <div className="pt-2 pb-2">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <p className="text-[10px] text-muted-foreground/80 tracking-[0.15em] uppercase select-none">
              ...
              {sources.map((s) => (
                <li key={s.url}>
                  ...
                  >
                    ...
                    <span className="hidden sm:inline shrink-0 text-[10px] text-muted-foreground/60">{s.domain}</span>
