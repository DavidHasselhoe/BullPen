    ...
    <div className="container mx-auto py-8 max-w-4xl px-4 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        ...
        >
          ...
          {t('tools:allToolsLink', 'All tools')}
        </Link>
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold tracking-tight text-foreground">
              {t('tools:portfolioBuilderTitle', 'Portfolio Builder')}
            </h1>
            <p className="text-sm text-muted-foreground mt-0.5">
              {t('tools:portfolioBuilderDescription', 'Type an investment thesis. Get a high-conviction thematic portfolio.')}
            </p>
          </div>
        </div>
      </div>
