          ...
          <CardContent className="p-5 sm:p-6 space-y-4">
            ...
            >
              <TickerSelector
                ...
                className="flex-1"
              />
              <Button type="submit" size="lg" disabled={!selected} className="gap-2 shrink-0 rounded-full bg-transparent hover:bg-transparent text-white animate-ai-pill-shine">
