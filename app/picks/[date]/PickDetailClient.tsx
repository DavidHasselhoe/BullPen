    ...
    <article>
      ...
      <section aria-label="Performance since the pick" className="mb-8">
        <dl className="grid grid-cols-2 gap-4 rounded-xl border border-border/50 bg-card/40 px-5 py-4 sm:grid-cols-4">
          <div>
            <dt className="text-[10px] font-bold uppercase tracking-[0.15em] text-muted-foreground/50">Entry</dt>
            <dd className="mt-1 font-mono text-sm tabular-nums text-foreground/90">
              {pick.entryPrice == null ? (
                <span className="text-muted-foreground/60">Pending open</span>
              ) : (
          ...
          <div>
            <dt className="text-[10px] font-bold uppercase tracking-[0.15em] text-muted-foreground/50">Now</dt>
            <dd className="mt-1 font-mono text-sm tabular-nums text-foreground/90">
          ...
          <div>
            ...
            <p className="mt-0.5 text-[11px] text-muted-foreground/60">over {heldFor(pick.pickDate)}</p>
          </div>
          <div>
            <dt className="text-[10px] font-bold uppercase tracking-[0.15em] text-muted-foreground/50">
              vs S&amp;P 500
      ...
      <p className="mt-10 border-t border-border/40 pt-4 text-[11px] leading-relaxed text-muted-foreground/70">
              ...
              <tbody>
                {thesis.evidence.map((row, i) => (
                  <tr key={i} className="border-b border-border/30 last:border-b-0">
                    ...
                    <td className="px-4 py-2.5 text-right text-[12px] text-muted-foreground/70">
                      {row.context ?? ''}
                    </td>
                  </tr>
                ))}
                ...
                <div className="flex items-start gap-2.5">
                  ...
                  <div className="min-w-0">
                    <h3 className="text-[14px] font-semibold text-foreground">
                      {r.title}
                      <span className="ml-2 font-normal text-[11px] text-muted-foreground/70">
      ...
      {thesis?.invalidation && (
        <section aria-labelledby="invalidation-heading" className="mb-8">
          <h2
            ...
            className="mb-2 text-sm font-semibold uppercase tracking-widest text-muted-foreground/60"
          >
      ...
      <div className="rounded-xl border border-border/50 bg-card/40 px-5 py-6">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0">
            ...
            <p className="mt-2 max-w-prose text-[12px] leading-relaxed text-muted-foreground/70">
